...
public class FaitRH {
    ...
    private final int    anneeAbsences;
    private final int    anneePromotionRecommandee;
    ...
    public FaitRH(String employeId, int deptId, int tempsId, int posteId, int formationId,
                  ...
                  int promotionRecommandee, int anneeDepart, int anneeEmbauche, int anneeFormation, int anneeNaissance, int anneeAbsences, int anneePromotionRecommandee) {
        ...
        this.anneeAbsences              = anneeAbsences;
        this.anneePromotionRecommandee  = anneePromotionRecommandee;
    }
    ...
    public static class Builder {
        ...
        private int    anneeAbsences              = -1;
        private int    anneePromotionRecommandee  = -1;
        ...
        public Builder anneeAbsences(int v)                  { this.anneeAbsences             = v; return this; }
        public Builder anneePromotionRecommandee(int v)      { this.anneePromotionRecommandee  = v; return this; }
        ...
        public FaitRH build() {
            return new FaitRH(employeId, deptId, tempsId, posteId, formationId,
                    ...
                    promotionRecommandee, anneeDepart, anneeEmbauche, anneeFormation, anneeNaissance, anneeAbsences, anneePromotionRecommandee);
        }
    }
    ...
    public int    getAnneeAbsences()               { return anneeAbsences; }
    public int    getAnneePromotionRecommandee()   { return anneePromotionRecommandee; }
